...
const start = (aruga = new Client()) => {
    ...
    console.log(color(figlet.textSync('IRFAN BOT', { font: 'Ghost', horizontalLayout: 'default' })))
    console.log(color(figlet.textSync('----------------', { horizontalLayout: 'default' })))
	...
	await aruga.sendText(chat.id, `Sorry, Grup Di Akun Bot Ini Telah Mencapai 450\nMax Group is: 450`).then(() => {
